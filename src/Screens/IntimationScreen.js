    ...
    try {
      ...
      const response = await fetch(ENDPOINTS.Add_Intimation, {
        ...
        body: JSON.stringify({
          ...
          loan_no: vehicleDetails.vehicle_agreement_no,
          rc_no: vehicleDetails.vehicle_registration_no,
...
money even after several reminders. We are going to repossess the vehicle
        ...
        <table>
          ...
          <tr>
            ...
            <td><strong>:</strong></td>
            <td>${vehicleDetails.vehicle_agreement_no || '----------'
      }</td>
          </tr>
            </tr>
            <th>Customer Name</th>
    ...
    <tr>
      ...
      <td>${time || '----------'}</td>
        ...
        <p>${vehicleDetails.vehicle_finance_name || '----------'
      }</p>
   <p>${SelectedAgency || '----------'
      }</p>
  ...
  `;
    ...
    try {
      ...
      const destinationPath =
        Platform.OS === 'android'
          ? `${RNFS.DownloadDirectoryPath}/PRE_PDF(${vehicleDetails.vehicle_registration_no}).pdf` // Pre download
          : `${RNFS.DocumentDirectoryPath}/PRE_PDF(${vehicleDetails.vehicle_registration_no}).pdf`; // iOS uses Document directory
...
even after several reminders. We had repossessed the vehicle.
    ...
    try {
      ...
      const destinationPath =
        Platform.OS === 'android'
          ? `${RNFS.DownloadDirectoryPath}/POST_pdf(${vehicleDetails.vehicle_registration_no}).pdf` // Post download
          : `${RNFS.DocumentDirectoryPath}/Post_pdf(${vehicleDetails.vehicle_registration_no}).pdf`; // iOS uses Document directory
  ...
  <body>
    ...
    <!-- Header -->
    <div class="header-title">PRE POLICE REPO INTIMATION OF VEHICLE ${vehicleDetails.vehicle_registration_no || '----------'} </div>
    ...
    <div class="footer-details">
      <p>${vehicleDetails.vehicle_finance_name || '----------'}</p>
      <p>${SelectedAgency || '----------'}</p>
    </div>
  </body>
  </html>
  ...
  const PostPdfAfterMail = async () => {
    ...
    const htmlContent = `
        <html>
          ...
          <body>
            ...
            <!-- Header Title -->
          <div class="header-title">POST POLICE REPO INTIMATION OF VEHICLE ${vehicleDetails.vehicle_registration_no || '----------'} </div>
            ...
            <table>
              ...
              <tr><th>Customer Name</th>  <td><strong>:</strong></td><td>${vehicleDetails.vehicle_customer_name || '----------'}</td></tr>
              <tr><th>Vehicle Registration No</th>  <td><strong>:</strong></td><td>${vehicleDetails.vehicle_registration_no || '----------'}</td></tr>
              <tr><th>Product Model</th>  <td><strong>:</strong></td><td>${vehicleDetails.vehicle_product || '----------'}</td></tr>
              <tr><th>Engine No</th>  <td><strong>:</strong></td><td>${vehicleDetails.vehicle_engine_no || '----------'}</td></tr>
              <tr><th>Chassis No</th>  <td><strong>:</strong></td><td>${vehicleDetails.vehicle_chassis_no || '----------'}</td></tr>
    ...
    try {
      ...
      const destinationPath =
        Platform.OS === 'android'
          ? `${RNFS.DownloadDirectoryPath}/POST_pdf(${vehicleDetails.vehicle_registration_no}).pdf`
          : `${RNFS.DocumentDirectoryPath}/Post_pdf(${vehicleDetails.vehicle_registration_no}).pdf`;
  ...
  const GeneratePdf = async () => {
    ...
    const messageContent = `*Manager :* ${vehicleDetails.vehicle_manager || ''}
*Month :* ${vehicleDetails.vehicle_month || ''}
*Finance :* ${vehicleDetails.vehicle_finance_name || ''}
*Branch :* ${vehicleDetails.vehicle_branch || ''}
*Agreement Number :* ${vehicleDetails.vehicle_agreement_no || ''}
*App ID :* ${vehicleDetails.vehicle_app_id || ''}
...
*Total Outstanding :* ${vehicleDetails.vehicle_total_outstanding || ''}
*RC Number :* ${vehicleDetails.vehicle_registration_no || ''}
*Chassis Number :* ${vehicleDetails.vehicle_chassis_no || ''}
*Engine Number :* ${vehicleDetails.vehicle_engine_no || ''}
*Repo Fos :* ${vehicleDetails.vehicle_repo_fos || ''}
*Field Fos :* ${vehicleDetails.vehicle_fild_fos || ''}`;
  ...
  const fields = [
    { label: 'Loan No', value: vehicleDetails.vehicle_agreement_no },
    ...
    { label: 'Product', value: vehicleDetails.vehicle_product },
    { label: 'Customer Name', value: vehicleDetails.vehicle_customer_name },
    { label: 'Manager', value: vehicleDetails.vehicle_manager },
    { label: 'Bucket', value: vehicleDetails.vehicle_bucket },
    { label: 'Pos', value: vehicleDetails.vehicle_principle_outstanding },
  ];
